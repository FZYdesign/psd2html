...
'use strict';
var ControlUI, DialogUI, Math, NAMESPACE, VERSION, WindowUI, boundsOffsetX, boundsOffsetY, clearInterval, clearTimeout, cloneLayer, close, copy, createDocument, currentHeight, currentWidth, enlargeForSelect, exec, extract, fileNameCounter, fileNames, getBounds, getLayerPath, getMetrics, getText, global, hideIgnoreLayers, hideLayerWithoutSelf, input, isNaN, isSelect, markupIgnore, nameCounter, offsetX, offsetY, originalHeight, originalWidth, output, outputCSS, outputJQUERY, outputJSON, outputLESS, pageWidth, paste, restoreDimension, revert, savable, saveFolder, saveGIF, saveJPEG, savePNG, selectAllLayers, setInterval, setTimeout, showLayer, startTime, structures, toSmartObject, varDump, _level,
...
markupIgnore = function() {
  ...
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    if (layer.visible === false && !/^_:/.test(layer.name)) {
      _results.push(layer.name = '_:' + layer.name);
    } else {

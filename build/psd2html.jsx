...
'use strict';
var ControlUI, DialogUI, Math, NAMESPACE, VERSION, WindowUI, boundsOffsetX, boundsOffsetY, clearInterval, clearTimeout, close, copy, createDocument, currentHeight, currentWidth, enlargeForSelect, exec, extract, fileNameCounter, fileNames, getBounds, getLayerPath, getMetrics, global, hideLayerWithoutSelf, input, isNaN, isSelect, nameCounter, offsetX, offsetY, originalHeight, originalWidth, output, outputCSS, outputJQUERY, outputJSON, outputLESS, paste, restoreDimension, revert, savable, saveFolder, saveGIF, saveJPEG, savePNG, selectAllLayers, setInterval, setTimeout, showLayer, structures, toSmartObject, varDump, _level,

...
'use strict';
var ControlUI, DialogUI, Math, NAMESPACE, VERSION, WindowUI, boundsOffsetX, boundsOffsetY, clearInterval, clearTimeout, cloneLayer, close, copy, createDocument, currentHeight, currentWidth, enlargeForSelect, exec, extract, fileNameCounter, fileNames, getBounds, getLayerPath, getMetrics, global, hideLayerWithoutSelf, input, isNaN, isSelect, nameCounter, offsetX, offsetY, originalHeight, originalWidth, output, outputCSS, outputJQUERY, outputJSON, outputLESS, paste, restoreDimension, revert, savable, saveFolder, saveGIF, saveJPEG, savePNG, selectAllLayers, setInterval, setTimeout, showLayer, structures, toSmartObject, varDump, _level,
...
cloneLayer = function(layer) {
  var child, newLayer, removeCOPY, _i, _len, _ref;
...
output = function(layers, ext, mix) {
  ...
  for (_i = 0, _len = layers.length; _i < _len; _i++) {
    ...
    if (layer.typename === 'LayerSet' && layer.visible) {
      ...
      (function() {
        var newLayer;
        return newLayer = cloneLayer(layer);
      })();

...
'use strict';
var ControlUI, DialogUI, Math, NAMESPACE, VERSION, WindowUI, boundsOffsetX, boundsOffsetY, clearInterval, clearTimeout, cloneLayer, close, copy, createDocument, currentHeight, currentWidth, enlargeForSelect, exec, extract, fileNameCounter, fileNames, getBounds, getLayerPath, getMetrics, getText, global, hideIgnoreLayers, hideLayerWithoutSelf, input, isNaN, isSelect, nameCounter, offsetX, offsetY, originalHeight, originalWidth, output, outputCSS, outputJQUERY, outputJSON, outputLESS, paste, restoreDimension, revert, savable, saveFolder, saveGIF, saveJPEG, savePNG, selectAllLayers, setInterval, setTimeout, showLayer, structures, toSmartObject, varDump, _level,

...
'use strict';
var ControlUI, DialogUI, Math, NAMESPACE, VERSION, WindowUI, boundsOffsetX, boundsOffsetY, clearInterval, clearTimeout, cloneLayer, close, copy, createDocument, currentHeight, currentWidth, enlargeForSelect, exec, extract, fileNameCounter, fileNames, getBounds, getLayerPath, getMetrics, getText, global, hideIgnoreLayers, input, isNaN, isSelect, markupIgnoreAndHide, nameCounter, offsetX, offsetY, originalHeight, originalWidth, output, outputCSS, outputJQUERY, outputJSON, outputLESS, pageWidth, paste, restoreDimension, revert, savable, saveFolder, saveGIF, saveJPEG, savePNG, selectAllLayers, setInterval, setTimeout, startTime, structures, toSmartObject, varDump, _level,
